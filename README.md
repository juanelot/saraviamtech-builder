...
> Para actualizar después de un cambio en el código: en Portainer ve al stack → **Update the stack** con la opción **Re-pull image** activada, o reconstruye manualmente desde el servidor.

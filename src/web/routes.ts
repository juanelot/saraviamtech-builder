...
apiRouter.get('/sections', (_req, res) => {
  const sections = [
    ...
    { type: 'text-mask',          label: 'Texto con Máscara',         group: 'Interactivo', description: 'Texto gigante con imagen o video como relleno' },
    { type: 'curtain-reveal',     label: 'Revelado Cortina',          group: 'Interactivo', description: 'Imagen que se desvela al hacer scroll' },
    { type: 'split-scroll',       label: 'Scroll Partido',            group: 'Interactivo', description: 'Dos columnas con scroll independiente' },
    { type: 'color-shift',        label: 'Cambio de Color',           group: 'Interactivo', description: 'Sección que cambia de paleta al hacer scroll' },
    { type: 'cursor-reactive',    label: 'Cursor Reactivo',           group: 'Interactivo', description: 'Elementos que reaccionan al movimiento del cursor' },
    { type: 'cursor-reveal',      label: 'Revelado por Cursor',       group: 'Interactivo', description: 'Imagen oculta que se revela con el cursor' },
    { type: 'image-trail',        label: 'Estela de Imágenes',        group: 'Interactivo', description: 'Imágenes que siguen el rastro del cursor' },
    { type: 'magnetic-grid',      label: 'Cuadrícula Magnética',      group: 'Interactivo', description: 'Cards con efecto magnético al cursor' },
    { type: 'coverflow',          label: 'Coverflow 3D',              group: 'Galería',     description: 'Carrusel estilo Apple con perspectiva 3D' },
    { type: 'view-transitions',   label: 'Transiciones de Vista',     group: 'Decorativo',  description: 'Navegación entre secciones con transición fluida' },
    { type: 'particle-button',    label: 'Botón de Partículas',       group: 'Decorativo',  description: 'CTA con explosión de partículas al hacer click' },
    { type: 'gradient-stroke',    label: 'Trazo Degradado',           group: 'Decorativo',  description: 'Tipografía outline con trazo en gradiente animado' },
    { type: 'dock-nav',           label: 'Nav Dock (macOS)',          group: 'Estructura',  description: 'Navegación estilo dock de macOS' },
    { type: 'drag-pan',           label: 'Arrastrar y Explorar',      group: 'Interactivo', description: 'Canvas arrastrable con grid de proyectos' },
    { type: 'dynamic-island',     label: 'Dynamic Island',            group: 'Decorativo',  description: 'Notificación flotante estilo iPhone Dynamic Island' },
